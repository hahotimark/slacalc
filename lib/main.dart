...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'SLA Calculator'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String startText = "1969-07-20 20:18:04Z";
  String endText = "1969-07-20 20:18:04Z";
  ...
  Widget build(BuildContext context) {
      ...
      String resultFinal = "0000000";


        String result = calResult.calculates(startText, endText);

        if ((result != null) && (result.length > 0)) {
          resultFinal = result.substring(0, result.length - 7);
        }
        else{
